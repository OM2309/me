      ...
      <div className="flex flex-wrap gap-2.5">
        {allSkills.map((skill) => (
          ...
          >
            ...
            {/* Name */}
            <span className="text-[13px] font-sans font-medium text-zinc-800 dark:text-zinc-200">
              {skill.name}
            </span>
          </div>
        ))}
